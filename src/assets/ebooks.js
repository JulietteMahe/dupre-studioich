const ebooks = [
    {
      ...
      "p3": "Affirmer son style et cultiver sa personnalité n’est pas une chose aisée surtout quand nous sommes confrontés à cette déferlante d’informations sur les réseaux, avoir du style prend du temps alors plutôt que de vous influencer, nous allons essayer de vous inspirer.",
      "p4": "Nous espérons de tout cœur que cet ebook vous aidera à sortir des sentiers battus, à avoir confiance en vous, à oser, à vous amuser."
    },
    {
      "id": 2,
      "title": "Spring style",
